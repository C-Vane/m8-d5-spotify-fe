...
function TrackList({ track, setCurrentSong }) {
  return (
    <div className='track-wrap d-flex justify-content-between align-items-start p-1' onClick={() => setCurrentSong({ Album: track.album, song: 0 })}>
