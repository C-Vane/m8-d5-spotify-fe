          ...
          <div className="nav-links">
            <ul>
              <li
                ...
                className={currentActiveLink === "Home" ? "link-item active" : "link-item"}
              >
                <Link to="/home">
              ...
              <li
                onClick={activeLinkHandler}
                className={currentActiveLink === "Search" ? "link-item active" : "link-item"}
              >
                <Link to="/search">
                  <svg viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                    <path
              ...
              <li
                onClick={activeLinkHandler}
                className={currentActiveLink === "Your Library" ? "link-item active" : "link-item"}
              >
          ...
          <div className="nav-footer text-left">
            <div className="container">
              ...
              <form action="login.html">
                <button id="log-in" href="/login.html" className="col-12">
                  LOGIN
                </button>
              </form>
